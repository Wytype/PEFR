...
def visualize_ranked_results(distmat, dataset, pid2Visual, save_dir='./vis-results/', sort='ascend', topk=20, mode='all', show='all', display_score=True):
    ...
    Args:
        ...
        pid2Visual[list] Or None: if None,visualize all query results;else visualize pids in []
    ...
    for q_idx in range(num_q):
        ...
        if pid2Visual == [] or qpid in pid2Visual:
